...
class User(AbstractUser,BaseModel):
    ...
    def check_pass(self):
        if not self.password:
            temp_pass=f"password{str(uuid.uuid4).split('-')[0]}"
...
class UserConfirmation(BaseModel):
    ...
    expiration_time=models.DateTimeField() # telefon raqam kiritib kod yuborildi 20:01 da kodning umri 2 daqiqa 20:01+2 javob 20:03 buni expiration_timega saqlanadi
